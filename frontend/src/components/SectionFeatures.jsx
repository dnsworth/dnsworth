  ...
  const features = [
    {
      ...
      avatar: "https://api.dicebear.com/7.x/adventurer/svg?seed=AI&backgroundColor=b6e3f4,c0aede,d1d4f9&t=" + Date.now(),
      name: "Dr. Smart",
      role: "AI Specialist",
      icon: "🧠",
    ...
    },
    {
      ...
      avatar: "https://api.dicebear.com/7.x/adventurer/svg?seed=Speed&backgroundColor=ffdfbf,ffd5dc,c9ffbf&t=" + Date.now(),
      name: "Flash Runner",
      role: "Speed Expert",
      icon: "⚡",
    ...
    },
    {
      ...
      avatar: "https://api.dicebear.com/7.x/adventurer/svg?seed=Market&backgroundColor=d4f4dd,ffd5dc,ffdfbf&t=" + Date.now(),
      name: "Market Master",
      role: "Data Analyst",
      icon: "📊",
    ...
    },
    {
      ...
      avatar: "https://api.dicebear.com/7.x/adventurer/svg?seed=Free&backgroundColor=c0aede,b6e3f4,d1d4f9&t=" + Date.now(),
      name: "Free Spirit",
