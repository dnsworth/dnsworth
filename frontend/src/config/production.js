...
export const PRODUCTION_CONFIG = {
  // API Configuration
  api: {
    baseURL: 'https://dnsworth.onrender.com:8000', // Working Render backend with correct port 8000
    timeout: 15000,
    retryAttempts: 3,
  },
  ...
  security: {
    ...
    csp: {
      ...
      'connect-src': ["'self'", "https://dnsworth.onrender.com:8000", "https://api.dnsworth.com", "http://localhost:8000"],
      'frame-src': ["'none'"],
      'object-src': ["'none'"],
      'base-uri': ["'self'"],
      'form-action': ["'self'"],
